...
def test_prestamo_exitoso():
    ...
    resultado = sistema.prestar_libro(usuario_id=1, libro_id=2)  # libro par → disponible
...
def test_usuario_no_autorizado():
    ...
    resultado = sistema.prestar_libro(usuario_id=0, libro_id=2)  # usuario no válido
...
def test_libro_no_disponible():
    ...
    resultado = sistema.prestar_libro(usuario_id=1, libro_id=3)  # libro impar → no disponible
